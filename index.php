...
//  更新指定工单
//	$data = $test->tickets()->update('1531',$json);
//  更新多个工单
...
//	回复指定工单
//  $data = $test->requests()->reply('1534',$json);
//  查找指定工单请求的所有回复
...
//	$info = array('upload'=>'C:\Users\Public\Pictures\Sample Pictures\shuimu.jpg');
//	上传附件
